var subtitles = {
    T_194198_video_assignment3: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:04:00"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese."),
			T(TTime("00:01:46:15"), TTime("00:01:55:00"), "GREENPEACE  Protect the Earth with your legacy")
        ]
    },
	
	T_194198_assignment_4b_2: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:04:00"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese."),
			T(TTime("00:02:58:15"), TTime("00:03:00:00"), "Stop denying our planet is dying"),
			T(TTime("00:03:37:05"), TTime("00:03:40:00"), "WE CHOOSE REWILDING"),
			T(TTime("00:03:40:00"), TTime("00:03:41:30"), "THE SCOTTISH REWILDING ALLIANCE"),
			T(TTime("00:03:41:30"), TTime("00:03:45:00"), "WWW.REWILD.SCOT")
        ]
    }
};
