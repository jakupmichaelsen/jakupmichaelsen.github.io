var subtitles = {
    T_182175_video_assignment3: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:05:00"), "Quorn"),
			T(TTime("00:00:58:15"), TTime("00:01:01:30"), "Duncan Williamson")
        ]
    },
	
    T_182175_video_assignment4b: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:04:15"), "ANAND GIRIDHARADAS"),
			T(TTime("00:00:04:15"), TTime("00:00:08:00"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese."),
			T(TTime("00:00:50:00"), TTime("00:00:55:00"), "Recorded at TED"),
			T(TTime("00:01:14:15"), TTime("00:01:20:00"), "TED"),
			T(TTime("00:11:06:15"), TTime("00:11:09:00"), "For more talks, visit TED.com"),
			T(TTime("00:19:09:13"), TTime("00:19:14:00"), "New TEDTALKS every day at www.TED.com"),
		]	
    }
};
