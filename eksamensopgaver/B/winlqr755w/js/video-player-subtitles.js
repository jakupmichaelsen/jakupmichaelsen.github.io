var subtitles = {
	...
	T_193319_assignment_5b: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:06:00"), "Northern Ireland - Scotland - Wales - England - London"),
			T(TTime("00:00:07:15"), TTime("00:00:10:00"), "Lake District<br />England")
        ]
    }
};
