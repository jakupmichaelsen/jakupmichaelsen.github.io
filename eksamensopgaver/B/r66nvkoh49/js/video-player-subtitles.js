var subtitles = {
    T_194199_assignment_2: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:02:00"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese."),
			T(TTime("00:00:02:00"), TTime("00:00:05:45"), "The Guardian<br />Facebook Jacinda Ardern")
			
        ]
    },
	
	T_194199_assignment_5B: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:03:00"), "Kun tekst, der er relevant for besvarelsen, er tekstet til talesyntese."),
			T(TTime("00:00:05:00"), TTime("00:00:08:00"), "TED"),
			T(TTime("00:00:13:40"), TTime("00:00:18:00"), "Guy Winch"),
			T(TTime("00:00:20:00"), TTime("00:00:23:00"), "April 2017 Vancouver BC"),
			T(TTime("00:00:27:00"), TTime("00:00:30:00"), "Recorded at TED")
        ]
    }
};
