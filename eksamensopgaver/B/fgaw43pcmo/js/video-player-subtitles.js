var subtitles = {
    T_191148_assignment_3: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:02:15"), "Kun tekst, der er relevant for besvarelsen, er tekstet til talesyntese.<br />Reuters"),
			T(TTime("00:00:02:15"), TTime("00:00:07:15"), "Vice President of the United States"),
			T(TTime("00:02:03:30"), TTime("00:02:09:00"), "Reuters")
        ]
    },
	
	T_191148_assignment_5b: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:05:00"), "Kun tekst, der er relevant for besvarelsen, er tekstet til talesyntese.")
        ]
    }
};
