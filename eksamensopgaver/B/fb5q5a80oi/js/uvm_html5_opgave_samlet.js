...
UVM.view = {
   ...
   *****************************************************************/
    ...
    * @author INGRAMA JKN
    *****************************************************************/
    funcLoadContent: function(intSelectedPageId, pageLayout, returnId, scrollTo) {
        this.funcDisableAll();
        ...
        if(pageLayout == "0") {
            ...
            $("#bottomMenu .subMenu a").attr("onclick", 'UVM.view.funcLoadContent(' + returnId + ', 0, 0, \"' + scrollTo + '\");');
        }
