var subtitles = {
    T_181436_video_opg3: {
        ...
        tracks: [
			...
			T(TTime("00:00:57:00"), TTime("00:00:58:30"), "RUFUS<br />CONGRESS 2018"),
			T(TTime("00:00:58:30"), TTime("00:01:00:00"), "RUFUSGIFFORD.COM<br />PAID FOR BY RUFUS GIFFORD FOR CONGRESS")
        ]
    },
	
    T_181436_video_opg4b: {
		lang: "en",
		name: "English",
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:05:00"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese."),
			T(TTime("00:00:05:00"), TTime("00:00:10:00"), "\"NATIONAL SHAME\"<br />TRUMP DECLARES OPIOID CRISIS A PUBLIC HEALTH EMERGENCY"),
			T(TTime("00:00:23:15"), TTime("00:00:26:00"), "Billy - Opioid addict"),
			T(TTime("00:01:31:30"), TTime("00:01:39:00"), "Megan - Opioid addict"),
			T(TTime("00:02:52:30"), TTime("00:02:56:00"), "Chief John McCarthy - Gloucester Police Department"),
			T(TTime("00:03:09:20"), TTime("00:03:17:15"), "Craig Opioid addict")
		]	
    }
};
